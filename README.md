...
I was a Summer Research Scholar at the School of Electrical Engineering and Computer Science at UQ, where I expanded the work [Learning Frequency Domain Codes for Semantic Vision to segmentation tasks](https://openreview.net/forum?id=FWEGmkHTJX), a direction that had not previously been explored. During this time, I derived a method that showed improved validation performance and memory efficiency compared to models such as U-Net. I am contributing as a co-author on this work, with the aim of publishing at leading Computer Vision conferences.
